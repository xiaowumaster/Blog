...
import cn.blog.lucene.BlogIndex;
...
public class BlogController {
  ...
  public ModelAndView details(@PathVariable("id") Integer id, HttpServletRequest request) throws Exception {
    ...
    mav.addObject("pageCode", getUpAndDownPageCode(this.blogService.getLastBlog(id), this.blogService.getNextBlog(id), request.getServletContext().getContextPath()));
          ...
          throws Exception
  {
    ...
    mav.addObject("pageCode", getUpAndDownPageCode(Integer.valueOf(Integer.parseInt(page)), Integer.valueOf(blogList.size()), q, Integer.valueOf(10), request.getServletContext().getContextPath()));
    mav.addObject("q", q);
